...
import chooseUserSlice from "../features/chooseUserSlice";
...
const persistConfig = {
    key: 'root',
    storage,
    whitelist: ['user', 'chooseUser'],
    // Hanya persist state dari startedBooking & user yang akan di persist (opsional)
}
